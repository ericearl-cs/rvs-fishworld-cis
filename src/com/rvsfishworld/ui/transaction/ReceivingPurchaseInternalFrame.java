...
public class ReceivingPurchaseInternalFrame extends JInternalFrame {
    ...
    private void openPrintDialog() {
        ...
        new ReceivingPrintDialog(SwingUtilities.getWindowAncestor(this), row).setVisible(true);
    }

    private void openCvDialog() {
        ReceivingDAO.BrowseRow row = getSelectedBrowseRow();
        if (row == null) {
            JOptionPane.showMessageDialog(this, "Select a receiving row first.");
            return;
        }
        new DisbursementEntryDialog(SwingUtilities.getWindowAncestor(this), row).setVisible(true);
    }
