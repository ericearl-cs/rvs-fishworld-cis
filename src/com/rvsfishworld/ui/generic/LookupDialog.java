...
public class LookupDialog extends JDialog {
    ...
    public LookupDialog(Window owner, String title, Function<String, List<LookupItem>> loader) {
        ...
        setSize(CisScale.scale(760), CisScale.scale(520));
    ...
    private JPanel buildTablePane() {
        JPanel panel = new JPanel(new BorderLayout(CisScale.scale(8), CisScale.scale(8)));
        panel.setBackground(FoxProTheme.PANEL);

        JPanel findBar = new JPanel(new FlowLayout(FlowLayout.LEFT, CisScale.scale(6), 0));
